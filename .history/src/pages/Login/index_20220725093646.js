...
const Login = (props) => {
  ...
  return (
    <KeyboardAvoidingView behavior='position' contentContainerStyle={styles.totalArea}>
      ...
      <KeyboardAvoidingView behavior='position' contentContainerStyle={styles.bottomArea}>
          <CheckBox
            center
            checked={radio}

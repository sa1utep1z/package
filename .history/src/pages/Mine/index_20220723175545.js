...
import { View, SafeAreaView, StyleSheet, TouchableOpacity, useWindowDimensions } from 'react-native';
...
const Mine = () => {
  ...
  console.log('_rem', _rem(200));
  console.log('scale',scale);

  return (
    <SafeAreaView style={styles.screen}>
      <View style={{height: _rem(150), borderWidth: 1, flexDirection: 'row', alignItems: 'center', paddingLeft: 30}}>
        <Avatar
          size={80}
          rounded

...
const InternationalSea = () => {
  ...
  return (
    <ScrollView style={styles.screen}>
      <View style={{alignItems: 'center', backgroundColor: '#fff', margin: 10, borderRadius: 8}}>
        ...
        <Text style={{height: 40, borderBottomWidth: 1, borderColor: '#CCCCCC', width: '100%', textAlignVertical: 'center', paddingLeft: 10}}>注册日期：</Text>

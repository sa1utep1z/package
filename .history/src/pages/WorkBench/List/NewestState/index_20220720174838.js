  ...
  const renderItem = ({item}) => {
    return (
      <View key={item.id} style={styles.listStyle}>
        <TouchableOpacity key={1} style={{flex: 1, justifyContent: 'center', alignItems: 'center', flexDirection: 'row'}} onPress={callMemberPhone}>
        ...
        <TouchableOpacity key={2} style={{flex: 1, justifyContent: 'center', alignItems: 'center'}} onPress={showFactoryDetail}>

...
const NewestState = ({
  ...
  return (
    <View style={{width: '100%'}}>
      {/* 阶段选择 */}
      <TouchableOpacity style={[styles.stage, showStage && styles.showStage, !showStage && styles.noShowStage]} onPress={stageOnPress}>
      ...
      {/* 状态选择 */}
      {stage && (
        <TouchableOpacity style={[styles.stage, showStatus && styles.showStage, !showStatus && styles.noShowStage]} onPress={statusOnPress}>
      ...
      {showReason && status?.reasonList?.length && 
        <TouchableOpacity style={[styles.stage, showReasonList && styles.showStage, !showReasonList && styles.noShowStage]} onPress={selectReasonOnPress}>

    ...
    <Dialog
      ...
      <View style={styles.msgArea}>
        ...
        <View style={{width: '100%'}}>
          ...
          {newestStatus && <View style={{width: '100%', height: 100, borderWidth: 1, borderTopWidth: 0, borderColor: '#EFEFEF', borderBottomLeftRadius: 8, borderBottomRightRadius: 8, marginBottom: 10, justifyContent: 'center'}}>
            <View style={styles.tags_little}>
              {statusList.length && statusList.map((item, index) => {
                const isFill = statusList.length % 3 === 2;
                const isLastElement = index === statusList.length - 1;

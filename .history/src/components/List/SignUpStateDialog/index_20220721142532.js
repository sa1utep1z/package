          ...
          {showStage && CHANGING_STAGE_LIST_IN_DIALOG.map((stage, stageIndex) => {
            return (
              <TouchableOpacity key={stageIndex} style={[{
                ...
                padding: 10, 
                height: 40
              }, stageIndex === CHANGING_STAGE_LIST_IN_DIALOG.length - 1 && {borderBottomLeftRadius: 8, borderBottomRightRadius: 8, marginBottom: 10 }]} onPress={()=>selectedStageOnPress(stage)}>

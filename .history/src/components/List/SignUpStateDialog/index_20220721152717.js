    ...
    <Dialog
      ...
      <View style={styles.msgArea}>
        ...
        <View style={{width: '100%'}}>
          ...
          {showReason && reason.length && <View style={{borderWidth: 1, borderTopWidth: 0, borderColor: '#EFEFEF', borderBottomLeftRadius: 8, borderBottomRightRadius: 8, marginBottom: 10, padding: 10}}>
            <View style={styles.tags_little}>

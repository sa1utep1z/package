  ...
  return (
    <Dialog
      ...
      <View style={styles.totalArea}>
        <Text h4 style={{textAlign: 'center', marginBottom: 10}}>你好</Text>
        ...
        <View style={{height: 40, borderWidth: 1, flexDirection: 'row'}}>
          <TouchableOpacity style={styles.leftBtn} onPress={()=>setShowDetail(!showDetail)}>
            <Text style={styles.leftBtnText}>取 消</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.rightBtn} onPress={save}>
            <Text style={styles.rightBtnText}>保 存</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Dialog>
...
export default forwardRef(NewestStateDialog);
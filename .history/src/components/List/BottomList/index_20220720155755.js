    ...
    <>
      <Tab
        ...
        {tabList.map((tab, tabIndex) => {
          ...
          return (
            <TouchableOpacity key={tabIndex} style={[{flex: 1, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center', minHeight: 60}]} onPress={setIndex}>
              <Text style={[active && {color: '#409EFF', fontWeight: 'bold'}]}>{tab.title}</Text>
            </TouchableOpacity>

        ...
        if (item.type === 'mobile') {
          return (
            <View style={styles.listItem} key={index}>
              <Text style={styles.listItem_text}>{item.title}：</Text>
              <TouchableOpacity style={[styles.listItem_item, { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }]} onPress={() => callPhone(item)}>
                <Text style={[styles.listItem_text, { color: '#409EFF' }]}>{item.value}</Text>

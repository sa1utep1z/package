...
const SecondWarn = ({
  ...
  const [searchContent, setSearchContent] = useState({result: 'DORM_DISCIPLINE_RESULT_SECONDARY_WARN', ...firstPage});
  ...
  useEffect(()=>{
    ...
    timer = setTimeout(()=>{
      ...
      getTypeList({...filterParams, result: 'DORM_DISCIPLINE_RESULT_SECONDARY_WARN'});
    }, 0)

    ...
    <>
      <ScrollView 
        ...
        <View style={{marginBottom: 10}}>
          ...
          {dateRangePicker && (
            <View style={[styles.selectArea, {flexDirection: 'column', paddingHorizontal: 10}]}>
              <View style={{flexDirection: 'row', alignItems: 'center', paddingVertical: 10}}>
                <Text style={{color: '#333'}}>本周期：</Text>
                <TouchableOpacity style={styles.selectTime} onPress={()=>showDate('THIS_START')}>
                  <AntDesign
                    ...
                    color='#333333'
                  />
                  <Text style={{marginLeft: 4}}>{moment(rangeTime.thisRange.startDate).format('MM-DD')}</Text>
                </TouchableOpacity>
                <Text style={{color: '#333', marginHorizontal: 10}}>至</Text>
                <TouchableOpacity style={styles.selectTime} onPress={()=>showDate('THIS_END')}>
                  <AntDesign
                    ...
                    color='#333333'
                  />
                  <Text style={{marginLeft: 4}}>{moment(rangeTime.thisRange.endDate).format('MM-DD')}</Text>
                </TouchableOpacity>
              </View>
              <View style={{flexDirection: 'row', alignItems: 'center', paddingBottom: 10}}>
                <Text style={{color: '#333'}}>上周期：</Text>
                <TouchableOpacity style={styles.selectTime} onPress={()=>showDate('LAST_START')}>
                  <AntDesign
                    ...
                    color='#333333'
                  />
                  <Text style={{marginLeft: 4}}>{moment(rangeTime.lastRange.startDate).format('MM-DD')}</Text>
                </TouchableOpacity>
                <Text style={{color: '#333', marginHorizontal: 10}}>至</Text>
                <TouchableOpacity style={styles.selectTime} onPress={()=>showDate('LAST_END')}>
                  <AntDesign
                    ...
                    color='#333333'
                  />
                  <Text style={{marginLeft: 4}}>{moment(rangeTime.lastRange.endDate).format('MM-DD')}</Text>
                </TouchableOpacity>
              </View>
            </View>
          )}
        ...
        <View style={{marginBottom: 10}}>
          <TouchableOpacity style={[styles.touchArea, showWay && styles.selectedTouchArea]} onPress={changeWay}>
